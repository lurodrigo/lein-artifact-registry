(defproject lurodrigo/lein-artifact-registry "0.1.0"
  ...
  :license {:name "MIT License"
            :url "https://github.com/polvotech/lein-artifact-registry/blob/master/LICENSE"}
  :eval-in-leiningen true
  :dependencies [[com.google.cloud.artifactregistry/artifactregistry-maven-wagon "2.0.0"]])
